...
public class AddDealsofDayAdapterNew extends RecyclerView.Adapter<AddDealsofDayAdapterNew.MyViewHolder>{
    ...
    public AddDealsofDayAdapterNew(Context context, ArrayList<DealsModelNew> selectCategoryModelArrayList) {
    ...
    @Override
    public AddDealsofDayAdapterNew.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                 int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.deals_add_new_activity, parent, false);
        AddDealsofDayAdapterNew.MyViewHolder myViewHolder = new AddDealsofDayAdapterNew.MyViewHolder(view);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(final AddDealsofDayAdapterNew.MyViewHolder holder, final int i) {
