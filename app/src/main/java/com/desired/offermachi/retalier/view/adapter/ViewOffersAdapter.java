...
public class ViewOffersAdapter extends RecyclerView.Adapter<ViewOffersAdapter.MyViewHolder>{
    ...
    public ViewOffersAdapter(Context context, ArrayList<SelectCategoryModel> selectCategoryModelArrayList) {
    ...
    @Override
    public ViewOffersAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                             int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.smart_shopping_remove_activity_new, parent, false);
        ViewOffersAdapter.MyViewHolder myViewHolder = new ViewOffersAdapter.MyViewHolder(view);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(final ViewOffersAdapter.MyViewHolder holder, final int i) {
