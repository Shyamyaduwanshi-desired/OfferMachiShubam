...
public class SmartShoppingRemoveAdapter extends RecyclerView.Adapter<SmartShoppingRemoveAdapter.MyViewHolder> {
       ...
       // public CardView categorylinear;
        ...
        public MyViewHolder(View itemView) {
           ...
           /* this.categorylinear=(CardView)itemView.findViewById(R.id.card_linear_id);*/
            ...
            this.removebutton=(Button)itemView.findViewById(R.id.remove_button_id);
            this.likeimg=(ImageView)itemView.findViewById(R.id.heart_image_id);
        }
    }
    public SmartShoppingRemoveAdapter(Context context,ArrayList<category_model> data) {
    ...
    @Override
    public void onBindViewHolder(final SmartShoppingRemoveAdapter.MyViewHolder holder, final int listPosition) {
