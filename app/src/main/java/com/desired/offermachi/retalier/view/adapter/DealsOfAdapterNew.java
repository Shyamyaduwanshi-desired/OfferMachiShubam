...
public class DealsOfAdapterNew extends RecyclerView.Adapter<DealsOfAdapterNew.MyViewHolder>{
    ...
    public DealsOfAdapterNew(Context context, ArrayList<DealsModelNew> selectCategoryModelArrayList) {
    ...
    @Override
    public DealsOfAdapterNew.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                 int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.add_deals_layout_new, parent, false);
        DealsOfAdapterNew.MyViewHolder myViewHolder = new DealsOfAdapterNew.MyViewHolder(view);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(final DealsOfAdapterNew.MyViewHolder holder, final int i) {
