...
public class MyLocationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    FloatingActionButton floting_add_botton;
    ...
    private void init() {
        ...
        floting_add_botton = findViewById(R.id.floting_add_botton);
        floting_add_botton.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void displayData1() {
        MyLOcationADapter myLOcationADapter = new MyLOcationADapter(MyLocationActivity.this, mylocation_modelslist);
