...
public class MobileVerifyActivity extends AppCompatActivity implements View.OnClickListener, CustomerForgotPasswordPresenter.CustomerForgotPassword {
    ...
    private void init(){
        presenter = new CustomerForgotPasswordPresenter(MobileVerifyActivity.this, MobileVerifyActivity.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(MobileVerifyActivity.this, RetalierDashboard.class));
        finish();
