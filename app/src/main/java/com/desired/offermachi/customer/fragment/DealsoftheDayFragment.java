...
public class DealsoftheDayFragment extends Fragment {
    View view;
    ...
    private void Categorydata() {
        ...
        category_model category_model2=new category_model(R.drawable.productfirst,"DOMINOZ PIZZA","Jul 31,2019","Share");
        productdataset.add(category_model2);
        category_model category_model3=new category_model(R.drawable.productsecond,"DOMINOZ PIZZA","Jul 31,2019","Share");
        productdataset.add(category_model3);
        category_model category_model4=new category_model(R.drawable.catseven,"DOMINOZ PIZZA","Jul 31,2019","Share");
