...
public class CityAdapter extends BaseAdapter {
    ...
    private ArrayList<CityBean> categoryModelArrayList;

    public CityAdapter(Context context, ArrayList<CityBean> categoryModelArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
       ViewHolder holder = null;
        ...
        holder.Offertype.setText(categoryModelArrayList.get(position).getCity_name());
        return convertView;
    }
}
