...
public class CustomerResetPasswordActivity extends AppCompatActivity implements View.OnClickListener, CustomerForgotPasswordPresenter.CustomerForgotPassword {
Button btndone;
...
private CustomerForgotPasswordPresenter presenter;
    ...
    private void init(){
        presenter=new CustomerForgotPasswordPresenter(CustomerResetPasswordActivity.this,CustomerResetPasswordActivity.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(CustomerResetPasswordActivity.this, LoginActivity.class));
        finish();
        overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
    }
