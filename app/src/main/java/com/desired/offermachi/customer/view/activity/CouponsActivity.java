...
public class CouponsActivity extends AppCompatActivity {
    ...
    private CustomerTrendingAdapter categoryAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  product_recyclerview = (RecyclerView) findViewById(R.id.coupons_recycler_id);
        categoryAdapter = new CustomerTrendingAdapter(getApplicationContext(), (ArrayList<category_model>) productdataset);
