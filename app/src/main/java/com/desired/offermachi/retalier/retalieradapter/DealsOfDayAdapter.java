...
public class DealsOfDayAdapter extends RecyclerView.Adapter<DealsOfDayAdapter.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            this.productname = (TextView) itemView.findViewById(R.id.productname_product_id);
            this.productdate = (TextView) itemView.findViewById(R.id.product_date_id);

        }
    }
    public DealsOfDayAdapter(Context context,ArrayList<retalier_category_model> data) {
    ...
    @Override
    public void onBindViewHolder(final DealsOfDayAdapter.MyViewHolder holder, final int listPosition) {
