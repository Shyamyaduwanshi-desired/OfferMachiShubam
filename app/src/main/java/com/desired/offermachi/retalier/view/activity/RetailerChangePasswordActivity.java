...
public class RetailerChangePasswordActivity extends AppCompatActivity implements View.OnClickListener,CustomerForgotPasswordPresenter.CustomerForgotPassword {
    Button btndone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retailer_change_password);
        init();
    }
    private void init(){
        presenter=new CustomerForgotPasswordPresenter(RetailerChangePasswordActivity.this,RetailerChangePasswordActivity.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(RetailerChangePasswordActivity.this, RetalierProfileActivity.class));
        finish();
        overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
    }
