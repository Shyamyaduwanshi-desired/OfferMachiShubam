...
public class SmartShoppingNotificationAdapter extends RecyclerView.Adapter<SmartShoppingNotificationAdapter.MyViewHolder>{
    ...
    public SmartShoppingNotificationAdapter(Context context, ArrayList<SelectCategoryModel> selectCategoryModelArrayList) {
