...
//                params.put("dist", "1");
//                params.put("dist", "500");
                Log.e("Home...","Input param= "+params.toString());
                return params;
            }
        };
    ...
    public void GetAllTrendingOffersStoreList(final String catid,final String userid) {
//        if(!((Activity) context).isFinishing())
        if(progress!=null)
        {
            progress.dismiss();
...
//        final ArrayList<SelectCategoryModel> list = new ArrayList<>();
        final ArrayList<SelectCategoryModel> list2 = new ArrayList<>();
        final ArrayList<StoreModel> list3 = new ArrayList<>();//customer_home_page_offers_data_bycategoryid,customer_home_page_offers_data_bycategoryid2
        StringRequest postRequest = new StringRequest(Request.Method.POST, AppData.url + "customer_home_page_offers_data_bycategoryid3", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                if(!((Activity) context).isFinishing())
                {
